...
const Header: React.FC = () => {
  ...
  return (
    <header className="flex fixed justify-between z-20 items-center top-0 left-16 right-0 h-16 bg-gradient-to-r from-purple-500 to-indigo-500 text-white shadow-md px-16">
